...
data_sourse = Position('Иван', 'Петров', 'библиотекарь', 80000, 15000)
print(f' должность {data_sourse.position} имя {data_sourse.name} {data_sourse.surname} '
      f'доход {data_sourse._income}')
print(f' сотрудник {data_sourse.get_full_name()} доход {data_sourse.get_total_income()}')
